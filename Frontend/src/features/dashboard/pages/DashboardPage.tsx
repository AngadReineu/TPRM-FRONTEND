    ...
    <div className="flex flex-col gap-7 max-w-[1280px]">
      ...
      <div className="grid grid-cols-4 gap-5">
        ...
        <KpiWidget
          ...
          label="Assessments"
          value={data.assessmentsTotal || 0}
          valueColor="#D97706"
          sub={
             <span className="text-slate-500 font-medium">View active assessments</span>
          }
          barPct={Math.min(100, Math.round(((data.assessmentsTotal || 0) / Math.max(1, totalVendors)) * 100))} barColor="#F59E0B" barBg="#FEF9C3"
        />
        ...
        <KpiWidget
          ...
          valueColor="#EF4444"
          sub={
            <span className="text-slate-500 font-medium">Active risk alerts</span>
          }
          barPct={Math.min(100, Math.round(((openRisks || 0) / Math.max(1, totalVendors)) * 100))} barColor="#EF4444" barBg="#FEE2E2"
        />
      </div>
