...
/**
 * Fetch agent definition by ID from the API with fallback to mock data.
 */
...
/**
 * Fetch tasks for an agent from the API with fallback to mock data.
...
/**
 * Fetch timeline for an agent from the API with fallback to mock data.
 * @param agentId - Agent ID
 * @param view - 'list' or 'detail' view type
 */
...
/**
 * Fetch initial logs for an agent from the API with fallback to mock data.
 * @param agentId - Agent ID
 * @param view - 'list' or 'detail' view type
 */
...
/**
 * Create input type for creating a new agent.
 */
...
/**
 * Update input type for updating an existing agent.
 */
...
/**
 * Update an existing agent via API.
 */
